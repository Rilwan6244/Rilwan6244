...
In my role, I:
- Provide cybersecurity consultancy to clients on improving their security posture
- Design and implement security solutions across Microsoft security technologies
- Perform full SOC onboarding for new clients
- Lead and support migrations into Microsoft Sentinel and Defender XDR
